...
// 일반(신) 석판: 고정 재능 2개[하위/중위/레전드중위] + 낙인 3개[하위/중위/레전드중위].
// 고정 슬롯도 레전드중위를 받는다(사용자 정정 — 낙인에만 반영돼 있었음, 2026-08-05).
const GOD_SLOTS: SlotSpec[] = [S('하위', '중위', '레전드중위'), S('하위', '중위', '레전드중위'), ...BRAND3]
